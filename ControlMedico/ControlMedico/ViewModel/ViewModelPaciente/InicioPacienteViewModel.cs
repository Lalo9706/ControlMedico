...
{
    internal class InicioPacienteViewModel : BaseViewModel
    {
        #region Attributes
        public object listViewSource = CitaRepository.RecuperarCitasPaciente(Settings.IdPaciente, DateTime.Today);
        public string hora;
        public string nombreCompletoPaciente;
        public string descripcion;
        public int idPaciente = Settings.IdPaciente;
        ...
        public ICommand ItemTappedCommand { get; } = new Command(async (item) =>
        {
            if (item != null)
            {
                ...
                await Application.Current.MainPage.Navigation.PushAsync(new DetallesCitaPaciente(citaSeleccionada));
            }
            else
            {
        ...
        public async void RecuperarCitasPorFecha()
        {
            ...
            this.ListViewSource = CitaRepository.RecuperarCitasPaciente(idPaciente, fechaSeleccionada);
